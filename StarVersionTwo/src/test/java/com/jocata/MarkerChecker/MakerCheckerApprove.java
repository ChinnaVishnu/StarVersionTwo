...
public class MakerCheckerApprove extends mainbaseLatest {
	...
	public void clickmarkApp(){
        ...
        ExtentTestManager.startTest("  Maker Checker : Approved "); 
...
public void clickingAnalayast(){
	...
	try{
 String approved= driver.findElement(By.xpath("//div[text()='Approved']")).getText();
...
*/	
	...
	String exceptedresult="Approved";
	sleep(4);
    ExtentTestManager.getTest().log(LogStatus.INFO, "Screenshortbelow :"+ExtentTestManager.getTest().addScreenCapture(GetScreenshort.capture(driver, "ScreenshortForExtentReport")));
    ...
    ExtentTestManager.getTest().log(LogStatus.INFO, " Maker Checker  Approved Sucessfully");
