...
public class ReportonCurrentCases extends mainbaseLatest {
	...
	public void addReport() throws InterruptedException, IOException {
		...
		ExtentTestManager.startTest(" MIS Report :   Report on Current Cases ");
		...
		try {
			...
			String target = " Report on Current Cases of Us...";
			...
			fluentWait(By.xpath("//input[@id='reportName']")).sendKeys("Report on Current Cases of User");
