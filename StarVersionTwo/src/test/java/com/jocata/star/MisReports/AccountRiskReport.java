...
public class AccountRiskReport extends mainbaseLatest {
	...
	public void addReport() throws InterruptedException, IOException {
		...
		ExtentTestManager.startTest(" MIS Report : Account Risk Report  ");
		...
		try {
			...
			String target = " Account Risk Report";
			...
			fluentWait(By.xpath("//input[@id='reportName']")).sendKeys(" Account Risk Report");
