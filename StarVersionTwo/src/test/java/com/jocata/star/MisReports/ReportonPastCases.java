...
public class ReportonPastCases extends mainbaseLatest {
	...
	public void addReport() throws InterruptedException, IOException {
		...
		ExtentTestManager.startTest(" MIS Report :    Report on Past Cases  ");
		...
		try {
			...
			String target = " Report on Past Cases of User";
			...
			fluentWait(By.xpath("//input[@id='reportName']")).sendKeys(" Report on Past Cases of User");
