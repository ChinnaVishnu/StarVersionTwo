...
public class AddManualEventCustomerid extends mainbaseLatest {
	...
	public void clickmanualevent() {
		...
		try {
			...
			ExtentTestManager.startTest("  Add Manual Event : Search Customer Id  Save ");
			...
			ExtentTestManager.getTest().log(LogStatus.FAIL, " Add Manual Event : Search Customer Id  Save ");
		}
