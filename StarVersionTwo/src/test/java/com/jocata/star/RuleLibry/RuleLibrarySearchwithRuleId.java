...
public class RuleLibrarySearchwithRuleId extends mainbaseLatest {
	...
	public void deletebenchmark() {
		...
		ExtentTestManager.startTest("  RuleLibrary : Search Rule with Rule ID ");
	...
	public void clickAddbench() throws HeadlessException, AWTException, IOException {
		...
		try {
			...
			sleep(6);
			ExtentTestManager.getTest().log(LogStatus.FAIL, " RuleLibrary : Search Rule with Rule  ID  ");
