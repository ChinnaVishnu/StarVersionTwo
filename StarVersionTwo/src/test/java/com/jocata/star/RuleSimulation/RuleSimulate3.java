...
*/
	...
	//	waitseee.until(ExpectedConditions.elementToBeClickable(By.xpath("//li/div")));
        ...
        actionfive.keyDown(Keys.CONTROL).click(teltfive.get(28)).click(teltfive.get(29)).click(teltfive.get(30)).click(teltfive.get(31))
         .click(teltfive.get(32)).click(teltfive.get(33)).click(teltfive.get(34)).click(teltfive.get(35))
        .keyUp(Keys.CONTROL).build().perform();
...
//.................................................... Schedule Definition....................................................//
	...
	driver.findElement(By.xpath(".//*[@id='repeatsFor-inputEl']")).click();
	
	driver.findElement(By.xpath("//li[text()='Daily']")).click();
	
	driver.findElement(By.xpath(".//*[@id='repeatEveryDaily']")).sendKeys("4");
	
	driver.findElement(By.xpath(".//*[@id='rulePeriod']")).sendKeys("40");
	
	driver.findElement(By.xpath(".//*[@id='rulePeriodType-inputEl']")).click();
	
	driver.findElement(By.xpath("//li[text()='Days']")).click();
	
	driver.findElement(By.xpath(".//*[@id='frequency']")).sendKeys("10");
	
	driver.findElement(By.xpath(".//*[@id='no_of_slices']")).sendKeys("5");
	
	driver.findElement(By.xpath("//span[@id='simulationbutton']")).click();
