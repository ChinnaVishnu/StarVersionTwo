...
public class ComboCheaker4  extends mainbaseLatest{
...
/*	//	fluentWait(By.xpath("//td[2]/div")).click();
		...
		driver.findElement(By.xpath(".//*[@id='workflowSubStatusCombo-triggerWrap']")).click();
		
	/*	
		WebElement element=	driver.findElement(By.xpath("//table[@id='casesTypesCombo-triggerWrap']//td[2]"));
		Actions action=new Actions(driver);
		...
		sleep(6);
		driver.findElement(By.xpath("//table[@id='casesTypesCombo-triggerWrap']//td[2]")).click();*/
		
		//driver.findElement(By.xpath("//input[@id='casesTypesCombo-inputEl']")).click();
...
*/
		//$$(".x-boundlist:not([style*='display: none']) div span")  
		
		
		//working for Customer Type
		
		
		List<WebElement> pagination =driver.findElements((By.cssSelector(".x-boundlist:not([style*='display: none']) div span"))); 
